...
\begin{tabular}{ |p{1.35cm}|p{1.8cm}|p{4cm}|p{4.7cm}|p{7cm}| }
  ...
  \textbf{\small{Severity}} & \textbf{\small{Likelihood}} & \textbf{\small{Risk}} & \textbf{\small{Prevention}} & \textbf{\small{Contingency}} \\ \hline % Row
