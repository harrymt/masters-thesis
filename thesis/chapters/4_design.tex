...
TODO include get started screenshot and end of setup screenshot and reminder screenshots here!
...
\begin{figure}[H]
  ...
  \caption{CHANGE THESE SCREENSHOTS. The screens initial users will see.}
  \label{fig:setup_media_1}
\end{figure}

TODO: TWEAK THIS SO ITS CORRECT:
\begin{itemize}
  \item \textbf{Setup}
  \begin{itemize}
...
Logo design by the Noun Project by Yu luck (\url{https://thenounproject.com/term/custom/402041/})
