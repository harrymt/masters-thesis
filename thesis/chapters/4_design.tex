...
To verify the effectiveness of each modality, an experiment was needed to test a reward on a large sample.
...
A system on a mobile device grants us access to a `highly available, contextually aware and interactive platform'~\cite{article_mhealth} and based on previous design recommendations for behaviour change mobile systems.
