...
Thus, the Fibit, would be a good primary platform for integrating vibration for rewards. However, due to technical limitations, as discussed in (TODO reference tech limitations chapter), we are unable to implement them.
