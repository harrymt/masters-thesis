...
\begin{tabular}{ |p{7cm}|p{6cm}|p{6.5cm}| }
  \hline
  \textbf{Combined} & \textbf{Stawarz et al.~\cite{article_beyond_self_tracking_designing_apps}} & \textbf{Weiser et al.~\cite{article_taxonomy_motivational_affordances_meaningful}} \\ \hline % Row
