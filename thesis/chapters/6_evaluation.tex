...
Briefly talk about Ethics approval, Kathys PHD 5.3.\newline
...
\begin{figure}[H]
  ...
  \caption{The landing page participants would see before they are taken to the Messenger bot: \url{www.harrymt.com/harryshabits}.}
  \label{fig:landing_page}
\end{figure}

\subsubsection{Participants}
60 participants were recruited on social networks (using the landing page: \url{www.harrymt.com/harryshabits}), and were mostly University students and staff. The process participants undertook is documented by the recruitment adverts (Figure~\ref{fig:recruitment}), the landing page (Figure~\ref{fig:landing_page}) and the setup screens (Section~\ref{user_flow}). They were instructed to connect with the bot via Facebook Messenger and pick a series of options to set-up their habit tracking. Participants answered general demographic information as set up questions from the bot when they connected with it (Section~\ref{user_flow}).
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.5in]{resources/feedback/adverts/css-post.png}
  \hspace{10px}
  \includegraphics[width=1.5in]{resources/feedback/adverts/hacksoc-post.png}
  \hspace{10px}
  \includegraphics[width=1.5in]{resources/feedback/adverts/msc-post.png}
  \hspace{10px}
  \includegraphics[width=1.5in]{resources/feedback/adverts/public-post.png}
...
The bot will collect the amount of habits participants complete versus their reward type. Habit completion will be verified by using the SRBAI questionnaire~\cite{article_4q_SRBAI}---A validated set of questions to measure habit automaticity levels. This will be used to test if participants are forming a habit. Various questions about how participants found their rewards were also asked (Appendix~\ref{app:end_of_study}. Finally, interviews with participants discuss the bot-delivered rewards for further verification.
...
TODO: Security of results

TODO:'Does giving users too much personalisation effect the study?'
...
\centering
 \begin{tikzpicture}
  ...
  \end{axis}
  \end{tikzpicture}
  \caption{H1M1: The rewards effect on habit performance. The sum of habits completed by participants with rewards versus the control group during 3-week study period.}~\label{fig:m1_h1}
...
%       xlabel={$u$ unemployment},
  ...
  \end{axis}
  \end{tikzpicture}
  \caption{H1M2: The rewards effect on habit automaticity. Comparing mean habit automaticity for rewards versus control group.}~\label{fig:m2_h1}
...
\subsubsection*{H1M2: the rewards effect on habit automaticity}
...
Rated 2 out of 5:\textit{'I felt a bit like I was being nagged, and I don't like being nagged. The rewards were a bit odd. Would be nice to actually set a time to be asked about the habit.'}


Rated 4 out of 5:\textit{'Interesting project but I did not ultimately feel motivated, the reminders became more of a chore than something I wanted to do.'}
