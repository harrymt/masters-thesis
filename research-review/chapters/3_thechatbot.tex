...
\begin{tikzpicture}[node distance=2cm]
  ...
  \node (fbmsgr) [process] {Messenger};
  \node (chatbot) [process] {Chatbot};
  \node (responses) [process, right of=chatbot, xshift=2cm] {Responses};
  \node (userend) [startstop] {User};
  ...
  \draw [arrow] (responses) -- node[anchor=east] {Response} (userend);
