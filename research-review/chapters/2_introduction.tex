...
\section{Introduction}
  ...
  \subsubsection{Recommendations for building reward focused habit forming systems
      - Requirements paired with multiple modalities

  \subsubsection{Habit reward system}
      - Web app\newline
  ...
  \subsection{Research Scope}
    (basically just go through current research section and write about it here first)
    - Kathys reserach\newline
    - Taxonomy, req for rewards\newline
    - MM habits
